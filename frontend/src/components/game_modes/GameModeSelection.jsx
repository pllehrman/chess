...
import { startNewGame } from './newChessGame';
...
export default function GameModeSelection() {
  ...
  async function handleStartGame() {
    let playerColor = colorChoice === 'random' ? (coinFlip() ? 'white' : 'black') : colorChoice;

    const playerWhite = playerColor === 'white' ? 0 : null;
    const playerBlack = playerColor === 'black' ? 0 : null;
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 px-4">
      <div className="max-w-2xl w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg p-10 space-y-10">
        ...
        <div className="space-y-2">
          <label htmlFor="username" className="block text-lg font-semibold text-gray-900 dark:text-gray-100 text-center">Enter Your Name</label>
          <input
            type="text"
            id="username"
            value={username}
        ...
        {/* Game Mode Selection */}
        <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-gray-100">Choose Game Mode</h2>
